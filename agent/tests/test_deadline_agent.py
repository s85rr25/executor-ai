...
from agents.deadline_agent import _extract_json, _parse_alerts_from_text, handle_deadline_agent_tool, run_deadline_agent
from seed.demo_estate import build_demo_estate
from store.redis_client import get_alerts, seed_demo_estate
...
def test_alert_ranking_puts_critical_alerts_first(monkeypatch) -> None:
    ...
    assert [alert.severity for alert in alerts[:2]] == ["critical", "critical"]
